...
/**
 * This class defines a Password parameter, which is the same as a String
 * parameter with the exception that its value will be hidden during input and
 * output.
 *
 *
       ...
       extends Parameter
{
  ...
  /**
   * Creates a new Password parameter with the specified name.  The display name
  ...
  /**
   * Creates a new Password parameter with the specified name and value.  The
   ...
   */
  public PasswordParameter(String name, String value)
  {
  ...
  /**
   * Creates a new Password parameter with the specified name and
   ...
   *                     value.
   */
  public PasswordParameter(String name, boolean isRequired)
  {
  ...
  /**
   * Creates a new Password parameter with the specified name, value, and
   ...
   * @param  value       The value to use for this parameter.
   */
  public PasswordParameter(String name, boolean isRequired, String value)
  {
  ...
  /**
   * Creates a new Password parameter with the specified name, display name,
   ...
   * @param  value        The value to use for this parameter.
   */
  public PasswordParameter(String name, String displayName, boolean isRequired,
                         String value)
  {
   ...
   * @param  value        The value to use for this parameter.
   */
  public PasswordParameter(String name, String displayName, String description,
  ...
  /**
   * Specifies the value to use for this password parameter.  Only values of
   * type string will be accepted.
   *
  ...
  {
    if ((parameter != null) && (parameter instanceof PasswordParameter))
    {
      PasswordParameter pp = (PasswordParameter) parameter;
      this.value       = pp.value;
      this.stringValue = pp.stringValue;
    }
  }
  ...
  {
    String returnStr = "<INPUT TYPE=\"PASSWORD\" NAME=\"" + prefix + name +
                       "\" VALUE=\"" + stringValue +
                       "\" SIZE=\"" + visibleColumns + "\">";
    return returnStr;
  }
   ...
   */
  @Override()
  public PasswordParameter clone()
  {
    PasswordParameter pp = new PasswordParameter(name, displayName, description,
                                                 isRequired, stringValue);
    pp.visibleColumns = visibleColumns;
    pp.setSensitive(isSensitive());
    return pp;
  }
}
