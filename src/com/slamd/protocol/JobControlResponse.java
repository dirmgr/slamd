 ...
 * server in response to a job control request.  It will include the job ID, a
       ...
       extends SLAMDMessage
{
  ...
  // The error message for the job control request.
  private String errorMessage;

  // The job ID from the job control request.
  private String jobID;



  /**
   * Creates a new instance of this job control response message which is
  ...
  /**
   * Creates a new instance of this job control response message with the
  ...
  /**
   * Retrieves the result code for the job control request.
   *
   * @return  The result code for the job control request.
   */
  ...
  /**
   * Specifies the result code for the job control request.
   *
   * @param  resultCode  The result code for the job control request.
   */
  ...
  /**
   * Specifies the error message for the job control request.
   *
   * @param  errorMessage  The error message for the job control request.
   */
