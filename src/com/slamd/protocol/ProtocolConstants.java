...
public final class ProtocolConstants
{
   ...
   */
  static final String PROPERTY_ACTUAL_DURATION = "actual_duration";
   ...
   */
  static final String PROPERTY_ACTUAL_START_TIME = "actual_start_time";
   ...
   */
  static final String PROPERTY_ACTUAL_STOP_TIME = "actual_stop_time";
   ...
   */
  static final String PROPERTY_AUTH_CREDENTIALS = "auth_credentials";
   ...
   */
  static final String PROPERTY_AUTH_ID = "auth_id";
   ...
   */
  static final String PROPERTY_AUTH_METHOD = "auth_method";
   ...
   * file.
   */
  static final String PROPERTY_CLASS_BYTES = "class_bytes";
   ...
   * transfer response.
   */
  static final String PROPERTY_CLASS_DATA = "class_data";
   ...
   */
  static final String PROPERTY_CLASS_NAME = "class_name";
   ...
   */
  static final String PROPERTY_CLIENT_ID = "client_id";
   ...
   */
  static final String PROPERTY_CLIENT_IP = "client_ip";
   ...
   */
  static final String PROPERTY_CLIENT_MANAGER_ID = "client_manager_id";
   ...
   */
  static final String PROPERTY_CLIENT_NUMBER = "client_number";
   ...
   */
  static final String PROPERTY_CLIENT_PORT = "client_port";
   ...
   */
  static final String PROPERTY_CLIENT_SHOULD_CLOSE = "client_should_close";
   ...
   * a job.
   */
  static final String PROPERTY_COLLECTION_INTERVAL = "collection_interval";
   ...
   * or permanent.
   */
  static final String PROPERTY_DISCONNECT_IS_TRANSIENT = "is_transient";
   ...
   * being closed.
   */
  static final String PROPERTY_DISCONNECT_REASON = "disconnect_reason";
   ...
   */
  static final String PROPERTY_DISPLAY_NAME = "display_name";
   ...
   */
  static final String PROPERTY_FILE_DATA = "file_data";
   ...
   */
  static final String PROPERTY_FILE_DESCRIPTION = "file_description";
   ...
   */
  static final String PROPERTY_FILE_NAME = "file_name";
   ...
   */
  static final String PROPERTY_FILE_TYPE = "file_type";
   ...
   * client.
   */
  static final String PROPERTY_IN_PROGRESS_DATA = "in_progress_data";
   ...
   * job.
   */
  static final String PROPERTY_IN_PROGRESS_REPORT_INTERVAL =
   ...
   */
  static final String PROPERTY_INCLUDE_DEPENDENCIES = "include_dependencies";
   ...
   * class for a job.
   */
  static final String PROPERTY_JOB_CLASS_NAME = "job_class_name";
   ...
   */
  static final String PROPERTY_JOB_CLASS_VERSION = "job_class_version";
   ...
   */
  static final String PROPERTY_CLIENT_STATE = "client_state";
   ...
   */
  static final String PROPERTY_CLIENT_STATE_MESSAGE = "client_state_message";
   ...
   * request.
   */
  static final String PROPERTY_JOB_CONTROL_OPERATION = "job_control_operation";
   ...
   * job.
   */
  static final String PROPERTY_JOB_STATISTICS = "job_stats";
   ...
   */
  static final String PROPERTY_JOB_ID = "job_id";
   ...
   */
  static final String PROPERTY_JOB_STATE = "job_state";
   ...
   */
  static final String PROPERTY_LOG_MESSAGES = "log_messages";
   ...
   */
  static final String PROPERTY_MAJOR_VERSION = "major_version";
   ...
   */
  static final String PROPERTY_MAX_CLIENTS = "max_clients";
   ...
   */
  static final String PROPERTY_MINOR_VERSION = "minor_version";
   ...
   */
  static final String PROPERTY_MONITOR_CLASSES = "monitor_classes";
   ...
   * collected by a job.
   */
  static final String PROPERTY_MONITOR_STATISTICS = "monitor_stats";
   ...
   * process a job.
   */
  static final String PROPERTY_NUM_CLIENTS = "num_clients";
   ...
   */
  static final String PROPERTY_PARAMETER_LIST = "parameter_list";
   ...
   */
  static final String PROPERTY_POINT_VERSION = "point_version";
   ...
   */
  static final String PROPERTY_REPORT_IN_PROGRESS_STATS =
   ...
   */
  static final String PROPERTY_REQUIRE_SERVER_AUTH = "require_server_auth";
   ...
   * by the client.
   */
  static final String PROPERTY_REQUESTED_CLASS_NAMES = "requested_class_names";
   ...
   */
  static final String PROPERTY_RESULT_CODE = "result_code";
   ...
   */
  static final String PROPERTY_RESULT_MESSAGE = "result_message";
   ...
   * restricted mode.
   */
  static final String PROPERTY_RESTRICTED_MODE = "restricted_mode";
   ...
   */
  static final String PROPERTY_START_TIME = "start_time";
   ...
   */
  static final String PROPERTY_STOP_TIME = "stop_time";
   ...
   */
  static final String PROPERTY_THREAD_ID = "thread_id";
   ...
   * to process a job.
   */
  static final String PROPERTY_THREADS_PER_CLIENT = "threads_per_client";
   ...
   */
  static final String PROPERTY_THREAD_STARTUP_DELAY = "thread_startup_delay";
   ...
   * file.
   */
  static final String PROPERTY_UPGRADE_FILE_DATA = "upgrade_file_data";
