 ...
 */
public class WhileNotInstruction
       extends Instruction
{
  ...
  /**
   * Creates a new whilenot instruction.
   *
   * @param  lineNumber   The line number of the script on which this whilenot
   *                      instruction begins.
   ...
   *                      evaluates to false.
   */
  public WhileNotInstruction(int lineNumber, Argument condition,
  ...
  /**
   * Retrieves the condition for this whilenot instruction.
   *
   * @return  The condition for this whilenot instruction.
   */
         ...
         throws ScriptException
  {
    ...
    jobThread.writeVerbose(lineNumber + ":  whilenot " +
