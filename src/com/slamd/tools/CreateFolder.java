...
/**
 * This class defines a utility that may be used to create a job folder from the
...
public class CreateFolder
{
  ...
  {
    CreateFolder creator = new CreateFolder(args);
    if (creator.sendRequest())
    {
      System.out.println("The job folder was created successfully.");
    }
    else
    {
      System.out.println("An error occurred while trying to create the job " +
                         "folder.");
    }
  }
   ...
   * @param  args  The command-line arguments provided to this program.
   */
  public CreateFolder(String[] args)
  {
  ...
  public static void displayUsage()
  {
    ...
    System.out.println(
"USAGE:  java -cp {classpath} CreateFolder {options}" + eol +
