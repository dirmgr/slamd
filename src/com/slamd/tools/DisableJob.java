...
/**
 * This class defines a utility that may be used to disable a scheduled job from
...
public class DisableJob
{
  ...
  {
    DisableJob disableJob = new DisableJob(args);
    if (disableJob.sendRequest())
    {
      System.out.println("The job was disabled successfully.");
    }
    else
    {
      System.out.println("An error occurred while trying to disable the job.");
    }
  }
  ...
  public static void displayUsage()
  {
    ...
    System.out.println(
"USAGE:  java -cp {classpath} DisableJob {options}" + eol +
"        where {options} include:" + eol +
"-j {jobID}      -- The ID of the job to disable" + eol +
