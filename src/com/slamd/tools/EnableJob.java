...
/**
 * This class defines a utility that may be used to enable a scheduled job from
...
public class EnableJob
{
  ...
  {
    EnableJob enableJob = new EnableJob(args);
    if (enableJob.sendRequest())
    {
  ...
  public static void displayUsage()
  {
    ...
    System.out.println(
"USAGE:  java -cp {classpath} EnableJob {options}" + eol +
"        where {options} include:" + eol +
"-j {jobID}      -- The ID of the job to enable" + eol +
