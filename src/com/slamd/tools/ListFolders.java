...
/**
 * This class defines a utility that may be used to list the job folders that
 * have been defined in the SLAMD server.  It does this by communicating with
 * the SLAMD administrative interface over HTTP to ensure that all appropriate
...
public class ListFolders
{
  ...
  private boolean showVirtual = false;
  ...
  {
    ListFolders listFolders = new ListFolders(args);
    listFolders.sendRequest();
  }
   ...
   * @param  args  The command-line arguments provided to this program.
   */
  public ListFolders(String[] args)
  {
  ...
  public static void displayUsage()
  {
    ...
    System.out.println(
"USAGE:  java -cp {classpath} ListFolders {options}" + eol +
"        where {options} include:" + eol +
"-V               -- Indicates that the list of virtual folders should " + eol +
"                    be displayed instead of the list of real folders" + eol +
