...
/**
 * This class defines a utility that may be used to request that the SLAMD
 * server reload its job classes.  This may be useful if a new version of a job
 * class has been installed and it is not desirable to restart the server.
 *
 *
 * @author   Neil A. Wilson
 */
public class ReloadJobClasses
{
  ...
  {
    ReloadJobClasses reloadJobClasses = new ReloadJobClasses(args);
    if (reloadJobClasses.sendRequest())
    {
      System.out.println("The job classes were reloaded successfully.");
    }
    else
    {
      System.out.println("An error occurred while trying to reload the job " +
                         "classes.");
    }
  }
   ...
   * @param  args  The command-line arguments provided to this program.
   */
  public ReloadJobClasses(String[] args)
  {
  ...
  public static void displayUsage()
  {
    ...
    System.out.println(
"USAGE:  java -cp {classpath} ReloadJobClasses {options}" + eol +
