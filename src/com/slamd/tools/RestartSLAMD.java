...
/**
 * This class defines a utility that may be used to restart the SLAMD server
 * from the command line.  Note that this will only restart the SLAMD server
 * itself, not the underlying servlet engine.
 *
 *
 * @author   Neil A. Wilson
 */
public class RestartSLAMD
{
  ...
  {
    RestartSLAMD restartSLAMD = new RestartSLAMD(args);
    if (restartSLAMD.sendRequest())
    {
      System.out.println("The SLAMD server was restarted successfully.");
    }
    else
    {
      System.out.println("An error occurred while trying to restart the " +
                         "SLAMD server.");
    }
  }
   ...
   * @param  args  The command-line arguments provided to this program.
   */
  public RestartSLAMD(String[] args)
  {
  ...
  public static void displayUsage()
  {
    ...
    System.out.println(
"USAGE:  java -cp {classpath} RestartSLAMD {options}" + eol +
