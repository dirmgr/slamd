...
/**
 * This class defines a utility that may be used to start the SLAMD server from
 * the command line.  Note that the servlet engine must already be running for
 * this to work; only the SLAMD server itself should be offline.
 *
 *
 * @author   Neil A. Wilson
 */
public class StartSLAMD
{
  ...
  {
    StartSLAMD startSLAMD = new StartSLAMD(args);
    if (startSLAMD.sendRequest())
    {
      System.out.println("The SLAMD server was started successfully.");
    }
    else
    {
      System.out.println("An error occurred while trying to start the SLAMD " +
                         "server.");
    }
  }
  ...
  public static void displayUsage()
  {
    ...
    System.out.println(
"USAGE:  java -cp {classpath} StartSLAMD {options}" + eol +
