...
/**
 * This class defines a utility that may be used to stop the SLAMD server from
 * the command line.  Note that the servlet engine must already be running for
 * this to work, and this will only stop the SLAMD server, not the underlying
 * servlet engine.
 *
 *
 * @author   Neil A. Wilson
 */
public class StopSLAMD
{
  ...
  {
    StopSLAMD stopSLAMD = new StopSLAMD(args);
    if (stopSLAMD.sendRequest())
    {
      System.out.println("The SLAMD server was stopped successfully.");
    }
    else
    {
      System.out.println("An error occurred while trying to stop the SLAMD " +
                         "server.");
    }
  }
  ...
  public static void displayUsage()
  {
    ...
    System.out.println(
"USAGE:  java -cp {classpath} StopSLAMD {options}" + eol +
