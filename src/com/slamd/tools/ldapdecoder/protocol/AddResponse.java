...
/**
 * This class defines an LDAP add response, which provides information about the
 * result of processing an add request.
 *
 *
       ...
       extends ProtocolOp
{
   ...
   */
  public AddResponse(int resultCode, String matchedDN, String errorMessage)
  {
  ...
  public ASN1Element encode()
  {
    ...
    return new ASN1Sequence(ADD_RESPONSE_TYPE, resultElements);
  }
         ...
         throws ProtocolException
  {
    ...
    return new AddResponse(resultCode, matchedDN, errorMessage, referrals);
  }
  ...
  public void toSLAMDScript(PrintStream scriptWriter)
  {
    ...
    scriptWriter.println("#### Add response captured at " + new Date());
