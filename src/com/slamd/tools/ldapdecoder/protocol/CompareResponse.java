...
/**
 * This class defines an LDAP compare response, which provides information about
 * the result of processing a compare request.
 *
 *
       ...
       extends ProtocolOp
{
   ...
   */
  public CompareResponse(int resultCode, String matchedDN, String errorMessage)
  {
  ...
  public ASN1Element encode()
  {
    ...
    return new ASN1Sequence(COMPARE_RESPONSE_TYPE, resultElements);
  }
   ...
   *
   * @return  The decoded compare response.
   *
   * @throws  ProtocolException  If a problem occurs while decoding the provided
   *                             ASN.1 element as a compare response.
   */
  public static CompareResponse decodeCompareResponse(ASN1Element element)
         throws ProtocolException
  {
    ...
    return new CompareResponse(resultCode, matchedDN, errorMessage, referrals);
  }
  ...
  public void toSLAMDScript(PrintStream scriptWriter)
  {
    ...
    scriptWriter.println("#### Compare response captured at " + new Date());
