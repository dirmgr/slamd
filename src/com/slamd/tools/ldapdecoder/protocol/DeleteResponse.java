...
/**
 * This class defines an LDAP delete response, which provides information about
 * the result of processing a delete request.
 *
 *
       ...
       extends ProtocolOp
{
   ...
   */
  public DeleteResponse(int resultCode, String matchedDN, String errorMessage)
  {
  ...
  public ASN1Element encode()
  {
    ...
    return new ASN1Sequence(DELETE_RESPONSE_TYPE, resultElements);
  }
         ...
         throws ProtocolException
  {
    ...
    return new DeleteResponse(resultCode, matchedDN, errorMessage, referrals);
  }
  ...
  public void toSLAMDScript(PrintStream scriptWriter)
  {
    ...
    scriptWriter.println("#### Delete response captured at " + new Date());
