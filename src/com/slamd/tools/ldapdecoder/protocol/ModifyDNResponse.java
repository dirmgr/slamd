...
/**
 * This class defines an LDAP modify DN response, which is used to provide
       ...
       extends ProtocolOp
{
   ...
   */
  public ModifyDNResponse(int resultCode, String matchedDN, String errorMessage)
  {
  ...
  public ASN1Element encode()
  {
    ...
    return new ASN1Sequence(MODIFY_DN_RESPONSE_TYPE, resultElements);
  }
   ...
   *
   * @return  The decoded modify DN response.
   *
   * @throws  ProtocolException  If a problem occurs while decoding the provided
   *                             ASN.1 element as a modify DN response.
   */
  public static ModifyDNResponse decodeModifyDNResponse(ASN1Element element)
         throws ProtocolException
  {
    ...
    return new ModifyDNResponse(resultCode, matchedDN, errorMessage, referrals);
  }
  ...
  {
    return "LDAP Modify DN Response";
  }
  ...
  public void toSLAMDScript(PrintStream scriptWriter)
  {
    ...
    scriptWriter.println("#### Modify DN response captured at " + new Date());
