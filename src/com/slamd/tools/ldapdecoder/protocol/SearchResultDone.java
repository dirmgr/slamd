...
/**
 * This class defines an LDAP search result done, which is used to indicate that
 * the server is done processing a search request.
 *
 *
       ...
       extends ProtocolOp
{
   ...
   */
  public SearchResultDone(int resultCode, String matchedDN, String errorMessage)
  {
  ...
  public ASN1Element encode()
  {
    ...
    return new ASN1Sequence(SEARCH_RESULT_DONE_TYPE, resultElements);
  }
   ...
   *
   * @return  The decoded search result done.
   *
   * @throws  ProtocolException  If a problem occurs while decoding the provided
   *                             ASN.1 element as a search result done.
   */
  public static SearchResultDone decodeSearchResultDone(ASN1Element element)
         throws ProtocolException
  {
    ...
    return new SearchResultDone(resultCode, matchedDN, errorMessage, referrals);
  }
  ...
  {
    return "LDAP Search Result Done";
  }
  ...
  public void toSLAMDScript(PrintStream scriptWriter)
  {
    ...
    scriptWriter.println("#### Search result done captured at " + new Date());
